...
// import { useTokenStatus } from "@/hooks/useTokenStatus"; // REMOVE IN PRODUCTION
...
const DepartmentsWithQuery = () => {
  ...
  const handleToggleStatus = async (department: Department) => {
    ...
    try {
      // The backend requires ALL mandatory fields in the PUT
      const updateData = {
  ...
  return (
    <div className="p-4 w-full overflow-x-auto">
      {/* DEBUG: Card removido - era apenas para teste */}
