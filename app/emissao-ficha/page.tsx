...
const Services = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-end w-full max-w-7xl mx-auto px-4 py-8 bg-blue-300 dark:bg-slate-950 dark:inset-shadow-sm dark:inset-shadow-white dark:border dark:border-white/10 dark:shadow-white/10">
      <CardTitle className="mb-4 text-2xl text-white">Atendimento:</CardTitle>

      <Card className="p-6 rounded-xl w-full bg-blue-50 dark:bg-slate-950 dark:inset-shadow-sm dark:inset-shadow-white dark:border dark:border-white/10 dark:shadow-white/10">
