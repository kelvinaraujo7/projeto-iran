...
import { Headset, ZoomIn, Scale, BanknoteArrowUp    } from "lucide-react"; 
    ...
    dark:bg-slate-950  inset-shadow-sm inset-shadow-white  border border-white/10  shadow-white/10"> 
      ...
      dark:bg-slate-950  inset-shadow-sm inset-shadow-white  border border-white/10 shadow-inner shadow-white/10">
        ...
        <div className="flex justify-start mb-4 ">
          ...
          <CardTitle className="text-center fs-50 mb-2 ml-110 itemns-center justify-center text-2xl text-blue-950 dark:text-white">
          Departamento
        </CardTitle>
        </div>
      ...
      className="mt-5 bg-blue-500 ml-270 text-white hover:bg-white hover:text-black bg-blue-400
       ...
       color={''} mt={'25px'} type='button' onClick={() => router.push('../emissao-ficha/servicee')}>Próxima Etapa</Button>     
    </div>
  );
};
