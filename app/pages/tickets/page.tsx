      ...
      <Card className="bg-slate-100 dark:bg-slate-950 mb-4 ml-4 mr-2 rounded-sm shadow-2xl shadow-card-foreground">
        <CardHeader className="flex justify-between">
          <div>
            ...
            <CardDescription>Lista de bilhetes de atendimento</CardDescription>
          </div>
          <div>
            <Button
              asChild
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center">Data/hora inicial</TableHead>
                <TableHead className="text-center">Data/hora final</TableHead>
