...
import { UserCheck, LayoutDashboard, BriefcaseBusiness, Speech, Users, Sofa, Video, Ticket } from 'lucide-react';
...
const Sidebar = () => {
    return ( 
        ...
        <Command className="bg-blue-200 dark:bg-slate-900 mt-5 ml-4 rounded-sm shadow-2xl 
        shadow-card-foreground w-sm h-screen">
            <div className="flex items-center justify-between p-4">
                <Image className="content-center w-1/2 mx-auto mt-4 mb-2"
                    src={logoCofen}  alt='Cofen' width={150}
                />
                <ModeToggle />
            </div>

            <CommandList className="h-full max-h-auto  rounded-2xl bg-blue-300 dark:bg-slate-950
